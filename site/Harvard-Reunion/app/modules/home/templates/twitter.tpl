...
<div class="nonfocal">
  {block name="twitterHeader"}
    <a class="tweetButton" href="{$tweetURL}" target="reunionTwitter" onclick="pageTracker._trackEvent('{$smarty.const.GA_EVENT_CATEGORY}', 'Twitter Post', '{$hashtag|escape:'javascript'}']);">
